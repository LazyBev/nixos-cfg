...
in lib.mkIf isSecbox {
  ...
  boot.kernelParams = [
    "audit=1" "audit_backlog_limit=8192" "module.sig_enforce=1"
    "lockdown=confidentiality" "slab_nomerge" "init_on_alloc=1"
    "init_on_free=1" "page_alloc.shuffle=1"
  ];
  ...
  boot.blacklistedKernelModules = [
    "dccp" "sctp" "rds" "tipc"
    "bluetooth" "btusb" "btintel" "uvcvideo" "pwc"
    "joydev" "pcspkr" "snd_hda_intel" "snd_hda_codec_hdmi" "snd_usb_audio"
    "thunderbolt" "firewire_ohci" "firewire_core" "nouveau" "radeon"
  ];
